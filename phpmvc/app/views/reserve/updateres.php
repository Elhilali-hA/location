...
<form action="<?php echo URL_ROOT; ?>/clients/edit/<?php echo $_GET['id'] ?>" method="post" 
  class="col-5 flex column text-center p-4 m-4 bg-light w-50 mx-auto mt-5 mb-5" style="border-radius:15px;height:54 0px" >
...
<div >
   ...
   <input  placeholder="" value="<?php echo $cars->Marque ?>"  name="Marque" class="form-control border "  value="" readonly>
...
<label class="float-left" for="exampleFormControlInput1">fullname</label>
...
<label class="float-left" for="exampleFormControlInput1">date-debut</label>
<input type="date" placeholder="date" name="datedebut" class="form-control border " >

</div>

<div >
<label class="float-left" for="exampleFormControlInput1">date-fin</label>
<input type="date" placeholder="date" name="datefin" class="form-control border " >
 ...
 <a href="<?php echo URL_ROOT; ?>/clients/show" class="btn btn-danger ml-3 ">Cancel</a>
